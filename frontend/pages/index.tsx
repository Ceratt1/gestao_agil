...
export default function Home({produtos} : HomeParameters) {
  ...
  return (
      ...
      <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
          <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
              <a href="https://flowbite.com" className="flex items-center">
                  <img src={null} className="mr-3 h-6 sm:h-9"/>
                  <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">AtrMundial</span>
              </a>
    ...
    <main className="mt-10">
      <div className="flex flex-col items-center my-12">
        <h2 className="mb-2 text-xl">Serviços</h2>
        <ProductCard nome="Reparação de relógio" imagem={""}/>

      </div>
      <div className="flex flex-col items-center my-12">
        <h2 className="mb-2 text-xl">Produtos</h2>
        <div className="flex flex-wrap justify-center gap-8">
            {produtos.map(produto => (
              <ProductCard key={produto.id} nome={produto.nome} imagem={produto.imagem} preco={produto.preco}/>
            ))}
        </div>
      </div>
    </main>
...
export async function getServerSideProps() {
  // aqui terá o fetch para a API
  const produtos: Produto[] = [
    {
      id: 1,
      nome: "Relógio de pulso preto",
      imagem: "",
      preco: 40.55
    },
    {
